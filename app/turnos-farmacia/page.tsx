    ...
    <main className="min-h-screen">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl sm:text-4xl font-bold text-primary mb-8">Turnos de Farmacia</h1>
          ...
          <div className="bg-card rounded-lg p-4 sm:p-6 md:p-8">
            ...
            <div className="space-y-6">
              ...
              <div className="mt-8">
                <h2 className="text-xl sm:text-2xl font-semibold text-primary mb-4">Próximamente</h2>
                <p className="text-card-foreground">
